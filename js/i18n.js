...
window.translations = {
  fr: {
    ...
    offer: {
      ...
      descriptionLabel: "Brève description de la prestation",
      descriptionPlaceholder: "Décrivez brièvement ce que fera l'artiste pour cet événement.",
      ...
      compensation: {
        ...
        workloadTaskDescriptionLabel: "Description de la tâche",
        workloadTaskDescriptionPlaceholder: "Ex. Préparation technique et coordination de plateau",
  ...
  en: {
    ...
    offer: {
      ...
      descriptionLabel: "Brief description of the service",
      descriptionPlaceholder: "Briefly describe what the artist will do for this event.",
      signatureTitle: "Signatures",
      ...
      compensation: {
        ...
        workloadTaskDescriptionLabel: "Task description",
        workloadTaskDescriptionPlaceholder: "Ex. Technical prep and stage coordination",
