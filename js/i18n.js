...
window.translations = {
  fr: {
    ...
    offer: {
      ...
      pdfHeaderTitle: "HUPR - Offre de service",
      ...
      pdfSignatureArtistLabel: "Représentant HUPR",
      ...
      pdfBalanceTitle: "Bilan",
      pdfBalanceTeamSubtotalLabel: "Sous-total équipe et tâches",
      ...
      compensation: {
        ...
        workloadRateManualLabel: "Valeur manuelle du taux horaire",
  ...
  en: {
    ...
    offer: {
      ...
      pdfBalanceTitle: "Summary",
      pdfBalanceTeamSubtotalLabel: "Team and tasks subtotal",
      ...
      compensation: {
        ...
        workloadRateManualLabel: "Manual hourly rate value",
